"""
Plants vs Zombies - Plant Component
====================================
Plant sprites: Sunflower, Peashooter, WallNut, CherryBomb, etc.
Includes bullets, sun, cars, and lawn-mower logic.
"""
...
class Plant(pg.sprite.Sprite):
    ...
    def animation(self):
        ...
        # Never mutate cached frames with set_alpha — that permanently dims
        # shared surfaces and breaks later blits (plants/zombies vanish).
