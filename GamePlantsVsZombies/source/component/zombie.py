"""
Plants vs Zombies - Zombie Component
=====================================
Zombie sprites: Normal, Conehead, Buckethead, Newspaper, Flag.
Handles walk, attack, die, and hypno states.
"""
...
class Zombie(pg.sprite.Sprite):
    ...
    def animation(self):
        if self.state == c.FREEZE:
            # Dim without mutating the frame cache.
        ...
        # Never set_alpha on cached frames — it permanently breaks transparency.
