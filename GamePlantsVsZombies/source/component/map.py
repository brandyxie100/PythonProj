"""
Plants vs Zombies - Map Component
=================================
Grid-based map: cell validity, screen↔grid conversion, plant placement.
"""
...
class Map:
    """Game grid (GRID_X_LEN x GRID_Y_LEN); tracks cell occupancy."""
